...
const createInitialSubmission = catchAsync(
  async (req: Request, res: Response) => {
    const data = await InitialSubmissionService.createInitialSubmissionIntoDB(
      req.body,
      req.user!
    );
    sendResponse(res, {
...
const getAllInitialSubmission = catchAsync(
  async (req: Request, res: Response) => {
    const result = await InitialSubmissionService.getAllInitialSubmissionFromDB(
      req.query
    );
    sendResponse(res, {
      success: true,
...
const getSingleInitialSubmission = catchAsync(
  async (req: Request, res: Response) => {
    const result =
      await InitialSubmissionService.getSingleInitialSubmissionFromDB(
        req.params.id
      );
    sendResponse(res, {
      success: true,
...
const updateInitialSubmission = catchAsync(
  async (req: Request, res: Response) => {
    const result = await InitialSubmissionService.updateInitialSubmissionFromDB(
      req.params.id,
      req.body
    );
    sendResponse(res, {
...
const deleteInitialSubmission = catchAsync(
  async (req: Request, res: Response) => {
    const result = await InitialSubmissionService.deleteInitialSubmissionFromDB(
      req.params.id
    );
    sendResponse(res, {
      success: true,
